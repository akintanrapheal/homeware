...
export function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-5 right-4 z-40 flex items-center gap-2.5 rounded-full bg-[#25D366] px-4 py-3.5 text-paper-50 shadow-[0_12px_34px_-10px_rgba(37,211,102,0.7)] transition-transform duration-300 hover:scale-105 active:scale-95 sm:bottom-7 sm:right-7"
    >
